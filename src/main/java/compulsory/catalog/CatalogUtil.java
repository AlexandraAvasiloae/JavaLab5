...
public class CatalogUtil {
    ...
    /**
     * this method write the contents of the compulsory.catalog to the file specified by the path
    ...
    /**
     * this method load the compulsory.catalog from file where it was saved
    ...
    /**
     * this method open the item from the compulsory.catalog, using Desktop class
     *
     * @param item
     * @throws IOException
     */
